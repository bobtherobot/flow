...
- [Tool override](tool-override.md) — hold Cmd/Ctrl for a temporary selection tool (restores tool + selection); tool lock forced permanently on and its three UI surfaces removed; found regression (forcing the lock also disabled vendor's auto-select-on-draw) fixed via a 2-site fork edit decoupling the two; shipped 2026-08-07, unit 631/631 + e2e fully green
