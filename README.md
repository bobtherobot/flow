...
![flow with a flowchart on the canvas — desktop menu bar and quick-actions row along the top, the tool rail and shape rail down the left, and the dockable Transform / Color / Stroke panels on the right](docs/images/screenshot.png)
