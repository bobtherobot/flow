...
/**
 * Style panel: background / stroke / text color, each with its own opacity. Text
 ...
 */
export function StylePanel({ sel }: { sel: SelectionStyle }) {
  const a = sel.appState;
  return (
    <div className="flow-style-panel">
      <ColorRow
        sel={sel}
        label="Fill"
